...
class Button(pg.sprite.Sprite):
    def __init__(self, mask_rect):
        pg.sprite.Sprite.__init__(self)

        self.image = pg.Surface((12, 12))
        self.image.fill('red')

        self.rect = self.image.get_rect(topleft=(mask_rect[0], mask_rect[1]))
        # pg.draw.rect(mask_surf, 'red', self.rect, 1)
        print('listo')
        
    def colors(self, color):
        buttons = buttons.fill(color)
...
class Items(pg.sprite.Sprite):
    def __init__(self, image='items_lvls.png'):
        ...
        self.item_list = [
            ...
            {"id":1, "name":"papa", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":2, "name":"jitomate", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":3, "name":"cebolla", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":4, "name":"agua", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":5, "name":"arroz", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":6, "name":"pan", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":7, "name":"mantequilla", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":8, "name":"pol_pollo", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":9, "name":"leche", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},
            {"id":10, "name":"huevo", 'quantity':0, 'quality':0, 'cat':1, 'cost':7.00,},

            # objetos de otro nivel 2
            {"id":11, "name":"pescado", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":12, "name":"pollo", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":13, "name":"res", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":14, "name":"cerdo", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":15, "name":"calamar", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":16, "name":"caracol", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":17, "name":"ostras", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":18, "name":"camaron", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
            {"id":19, "name":"hueva_pez", 'quantity':0, 'quality':0, 'cat':2, 'cost':7.00,},
    ...
    def gen_items(self):
        ...
        for item in self.item_list:
            ...
            if item['quantity']  == 0:
                print(item_list['id'], item_list['name'])
